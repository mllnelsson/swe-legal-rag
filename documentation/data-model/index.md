...
* [sessions](sessions.md) - Conversation history backing the chat endpoint's follow-up support and the conversation list, plus the agent's own persisted scratchpad; the transcript holds the question and the answer only, never the evidence a turn gathered.

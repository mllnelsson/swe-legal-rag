...
* [Worker Architecture Patterns](worker-patterns.md) - The conventions every subscriber worker shares — the run_pipeline_step task envelope, session-per-message, and the commit-before-publish invariant.

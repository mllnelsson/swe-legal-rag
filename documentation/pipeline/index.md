...
* [Worker Architecture Patterns](worker-patterns.md) - The conventions every subscriber worker shares — the run_pipeline_step task envelope, its per-step progress logging, the subscribe/serve startup split, injected trace scopes, and the commit-before-publish invariant.
